export const COMPANY = {
  name: 'Crédito Forte',
  razaoSocial: 'Crédito Forte Empresa Simples de Crédito e Serviços Financeiros LTDA',
  cnpj: '33.977.652/0001-30',
  situacao: 'Ativa',
  abertura: '19/06/2019',
...
export const MISSAO =
  'Apoiar os micro e pequenos empreendedores, para que tenham oportunidade de adquirir capital de giro para expandir o seu negócio, sem distinção de segmento.'

export const VISAO =
  'Ser reconhecida no estado da Bahia como a melhor oportunidade para adquirir capital de giro para o crescimento empresarial dos pequenos e médios empreendedores, além de promover o crescimento pessoal e profissional dos nossos sócios, funcionários e colaboradores.'
